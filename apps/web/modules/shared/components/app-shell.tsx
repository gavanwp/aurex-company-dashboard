...
const MODULE_NAV: NavItem[] = [
  ...
  { label: 'Calendar', icon: Calendar, soonHint: 'Calendar is coming soon' },
  { label: 'Email center', icon: Mail, soonHint: 'Email center is coming soon' },
  { label: 'Finance', icon: CircleDollarSign, soonHint: 'Finance is coming soon' },
  { label: 'Invoices', icon: Receipt, soonHint: 'Invoices are coming soon' },
